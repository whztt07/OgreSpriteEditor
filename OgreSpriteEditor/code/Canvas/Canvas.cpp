...
Canvas::Canvas(Atlas* atlas, Ogre::Viewport* viewport, Ogre::uint zOrder) : atlas(atlas), viewport(viewport), vertexData(0), indexData(0),
	bufferSize(100), renderQueueID(Ogre::RENDER_QUEUE_OVERLAY+zOrder), isDirty(false), visibility(true)
{
